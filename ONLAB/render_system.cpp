...
namespace v {
    ...
    void RenderSystem::renderGameObjects(VkCommandBuffer& cmd, int currentFrame, RenderInfo renderinfo) {
        ...
        //TODO
            ...
            vkCmdBindDescriptorSets(cmd, VK_PIPELINE_BIND_POINT_GRAPHICS, pipelineLayout, 2, 1, &renderinfo.gameobjects.at(0)->getDescriptorSet(currentFrame), 0, nullptr);
            ...
            renderinfo.gameobjects.at(0)->model->draw(cmd, pipelineLayout, currentFrame, false);
