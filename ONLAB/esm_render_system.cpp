...
namespace v {
	...
	void ESM_RenderSystem::renderGameObjects(OffScreenRenderInfo renderinfo, ColorShadowMap& shadowMap, VkDescriptorSet descriptorSetShadowmap) {
	...
	void ESM_RenderSystem::createPipeline(VkRenderPass renderPass) {
