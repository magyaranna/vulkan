...
namespace v {
	...
	ShadowmapRenderSystem::ShadowmapRenderSystem(Device& device, std::vector<VkDescriptorSetLayout> setLayouts, VkRenderPass renderPass) : device(device) {
	...
	void ShadowmapRenderSystem::renderGameObjects(OffScreenRenderInfo renderinfo, DepthShadowMap& shadowMap) {
	...
	void ShadowmapRenderSystem::createPipelineLayout(std::vector<VkDescriptorSetLayout> setLayouts) {   //texture, modelmx, light
	...
	void ShadowmapRenderSystem::createPipeline(VkRenderPass renderPass) {

		const std::string vert = "shaders/SMdepthVert.spv";
